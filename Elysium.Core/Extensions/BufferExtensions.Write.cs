...
public static partial class BufferExtensions
{
    ...
    public static void Write(this Span<byte> writer, ref int offset, sbyte value)
    {
        writer[offset++] = (byte)value;
    }

    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public static void Write(this Span<byte> writer, ref int offset, byte value)
    {
        writer[offset++] = value;
    }

    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public static void Write(this Span<byte> writer, ref int offset, bool value)
    {
        writer[offset++] = (byte)(value ? 1 : 0);
    }
    ...
    public static void Write(this Span<byte> writer, ref int offset, double value)
    {
        ...
        offset += sizeof(double);
        Unsafe.ReadUnaligned<int>(ref writer[0]);
    }
}
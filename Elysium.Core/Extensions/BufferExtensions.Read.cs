...
public static partial class BufferExtensions
{
    ...
    {
        return (sbyte)reader[offset++];
    }

    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public static byte ReadUInt8(this ReadOnlySpan<byte> reader, ref int offset)
    {
        return reader[offset++];
    }

    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public static bool ReadBool(this ReadOnlySpan<byte> reader, ref int offset)
    {
    ...
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public static sbyte ReadInt8(this Span<byte> reader, ref int offset)
    {
        return (sbyte)reader[offset++];
    }

    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public static byte ReadUInt8(this Span<byte> reader, ref int offset)
    {
        return reader[offset++];
    }

    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public static bool ReadBool(this Span<byte> reader, ref int offset)
    {
        return reader[offset++] != 0;
    }

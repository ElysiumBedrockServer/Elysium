...
public static class ServiceCollectionExtensions
{
    ...
    internal static IServiceCollection AddPacketOnline<T>(this IServiceCollection services, string key)
        where T : class, IOnlinePacketParser
    {
    ...
    internal static IServiceCollection AddPacketOffline<T>(this IServiceCollection services, string key)
        where T : class, IOfflinePacketParser
    {
